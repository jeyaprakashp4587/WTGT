  ...
  return (
    <div className="about-wrapper container mt-5" id="about">
      ...
      <div className="about-wrapper-right">
        ...
        <p>
          At Rynex, we specialize in innovative web app development to transform
          ...
          aiming to optimize workflows, Rynex is your trusted partner in
          crafting tailored solutions that drive success. Why Choose Rynex?
          Expertise in the latest web technologies and frameworks. Commitment to
          delivering scalable and secure applications. Customer-centric approach
          to ensure your vision comes to life. Let’s turn your web app ideas
          into reality—where tech gets transformed!
        </p>
      </div>
    </div>
  );
